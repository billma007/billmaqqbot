...
第二个 `.in`里面填写你想要处理信息的群号码。如果你不需要，把实例数字山区即可。
...
首先打开 `force.json`,在superadmin里面填上自己的QQ（**全程在英文状态下输入！全程在英文状态下输入！全程在英文状态下输入！**），要打双引号。**多个QQ要有*英文半角逗号* 隔开。**普通管理员和黑名单成员可以使用bot
